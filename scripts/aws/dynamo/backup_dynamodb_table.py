...
Examples:
  ...
  # Backup all tables
  python scripts/aws/dynamo/backup_dynamodb_table.py --all
  python scripts/aws/dynamo/backup_dynamodb_table.py --all --yes
  ...
  python scripts/aws/dynamo/backup_dynamodb_table.py GameCatalog --region us-west-2
  python scripts/aws/dynamo/backup_dynamodb_table.py --all --region us-west-2
        """
    )
    parser.add_argument(
        'table_name',
